...
<!--Cabecera-->
            <div class="page-title">
              ...
              {!! Form::open(['route' => 'forosestudiantes.index', 'method'=>'GET', 'class'=>'form-horizontal form-label-left' ]) !!}
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="contenido">
              ...
              <div class="col-xs-2 col-sm-2 col-md-1  col-md-offset-1 col-lg-1 col-lg-offset-1">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 post-preview">
                    <a href="{{url('forosestudiantes',$foro->id)}}">
                        <h2 class="post-title">
                            {{$foro->titulo}}
                        </h2>
...
@endsection
@section('script')
  @include('estudiantes.foros.foro-nuevo')
