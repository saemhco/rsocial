        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{url('estudianteproyecto')}}" class="site_title"><i class="fa fa-files-o"></i> <span>Proyectos</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <li><a href="{{url('estudianteproyecto')}}"><i class="fa fa-file-text">
                    </i> Proyectos <span class="fa fa-circle"></span></a></li>
                  
                  <li><a href="{{url('forosestudiantes')}}"><i class="fa fa-list-alt">
                    </i> Foros <span class="fa fa-circle"></span></a></li>
                  <li><a href="{{url('estudiantencuesta')}}"><i class="fa fa-line-chart">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="#"  onclick="editar('{{Auth::user()->id}}')" data-toggle="modal" data-target="#EditarE"><i class="fa fa-cogs pull-right"></i><span>
                    {{Auth::user()->nombres}}</a></li>
                    
                    <li><a href="#" target="_blank"><i class="fa fa-info pull-right"></i>Ayuda </a></li>
