...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
      <a href="{{url('docenteproyecto')}}" style="color: green;"><i id="ico-plus" class="fa fa-arrow-left"></i> volver </a>
        <div class="x_title">
          <div align="center"><h2 ><b> Nuevo Proyecto </b></h2></div>  
            <div class="clearfix"></div>
        </div>  
        <div class="x_content" >
          {!! Form::open(['route' => 'docenteproyecto.store', 'method' => 'POST', 'class'=>'form-horizontal form-label-left', 'enctype'=>'multipart/form-data']) !!}                     
              <div class="item form-group">
                <div class="col-md-12 col-sm-12 col-xs-12">
                <label>Curso</label>
                {!!Form::select('curso',$cursos,null,['required','id'=>'curso','class'=>'form-control unidad','style'=>'width: 100%','placeholder' => 'Seleccione','enctype'=>'multipart/form-data'])!!}
                </div>
              </div>
              ...
              <div class="item form-group">
                <div class="col-md-12 col-sm-12 col-xs-12">
                <label>Tipo</label>
                {!!Form::select('tipo',$tipos,null,['required','class'=>'form-control unidad','placeholder' => 'Seleccione'])!!}
                </div>
              </div>
              <div class="item form-group">
                <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="item form-group">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <label>Ciclo</label>
                  {!!Form::text('ciclo', null, [ 'required','class'=> 'form-control', 'placeholder'=>'Ciclo académico'])!!}
                </div>
              </div>
              <div class="item form-group">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <label>Sección</label>
                  {!!Form::text('seccion', null, [ 'required','class'=> 'form-control', 'placeholder'=>'Sección'])!!}
                </div>
              </div>
              ...
              <div class="item form-group">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <label>Título</label>
                  {!!Form::text('titulo', null, [ 'required','class'=> 'form-control', 'placeholder'=>'Titulo del proyecto'])!!}
                </div>
              </div>
              <div class="item form-group">
                <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="item form-group">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  {!!Form::text('porcentaje', null, [ 'required','class'=> 'form-control', 'placeholder'=>'%'])!!}
                </div>
              </div>
              <div class="item form-group">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <br />
                      ...
                      <div class="col-md-12"><br>
                        <div class="modal-footer">
                          <button class="btn btn-success btn-lg" onclick="captura()">Registrar</button>
                        </div>
                      </div>
          {!! Form::close() !!}
        </div>        
