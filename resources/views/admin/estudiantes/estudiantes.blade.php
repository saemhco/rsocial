...
@endsection
@section('contenido')
@include('admin.estudiantes.nuevo-estudiante')
@include('admin.estudiantes.eliminar-estudiante')
<!-- Small modal-Editar -->
...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><b>Estudiantes </b><a href="#" data-toggle="modal" data-target="#NuevoEstudiante"
                    ...
                    <table  id="datatable-fixed-header" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        @foreach($es as $d)
                          ...
                          <td>
                            <a 
                              href="#" onclick="editar('{{$d->id}}')" id="editar" data-toggle="modal" data-target="#EditarE" ><i class="fa fa-pencil-square-o" title="Editar" ></i>
...
//Editar tutor
      ...
      function eliminar(ids){
        var id=ids;
        document.getElementById("eliminar-e").href ="adminestudiante/eliminar/"+id;
      }    
  </script>
@endsection