           <!-- Small modal -->
    <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-hidden="true" id="NuevoEstudiante">
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Registrar Nuevo Estudiante</h4>
                        </div>
                        <div class="modal-body">

                            
                          {!! Form::open(['route' => 'adminestudiantes.store', 'method' => 'POST', 'class'=>'form-horizontal form-label-left' ]) !!}                     
                      ...
                      <div class="item form-group">
                            ...
                            <label>Fecha de Nacimiento</label>
                              {!!Form::date('f_nac', \Carbon\Carbon::now(), ['required', 'class'=> 'form-control'])!!}
                            </div>
                      </div>
                      <div class="item form-group">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                            <label>Fecha de Ingreso</label>
                              {!!Form::date('f_ing', \Carbon\Carbon::now(), ['required', 'class'=> 'form-control'])!!}
                            </div>
                      </div>
